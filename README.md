...
2. Navigate to the creator's posts page, e.g. https://www.patreon.com/c/creatorname/posts
...
| FILTER_TITLE | Only include posts whose title contains this text. Leave blank for all posts. | "Chapter" |
